...
// mise en place de l'écouteur sur le bouton 'Download CV' //supprimer
/*const dlcv = document.getElementById("dlcv");
dlcv.addEventListener("click", function () {
...
function inputValidation(input, rule, msgTag, msg) {
  ...
  if (rule.test(target.value)) {
    ...
    setTimeout(deleteError, 2000, msgTag);
    errorForm = true;
...
function dropdownMenu() {
  let menuDropdown = document.getElementById("sous-menu");
  console.log("dropdown menu classes : ", menuDropdown.className);
